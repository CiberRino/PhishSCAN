...
# How to use 
python3 urslcan.py https://your-url-suspicious.com [flags]
...
The scoring system increases the risk score whenever a rule matches. Based on the final score, the URL is classified as: possible low risk, possible medium risk, or possible high risk. The final score is also displayed.
